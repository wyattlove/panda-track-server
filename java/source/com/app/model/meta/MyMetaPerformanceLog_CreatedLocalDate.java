...
public class MyMetaPerformanceLog_CreatedLocalDate
    extends KmMetaDateProperty<MyPerformanceLog>
{
    //##################################################
    //# accessing
    //##################################################
    ...
    @Override
    public KmDate getValueFor(MyPerformanceLog model)
    {
        return model.getCreatedLocalDate();
    }
    
    @Override
    public boolean hasValueFor(MyPerformanceLog model, KmDate value)
    {
