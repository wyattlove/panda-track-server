...
public class MyMetaFile_CreatedLocalDate
    extends KmMetaDateProperty<MyFile>
{
    //##################################################
    //# accessing
    //##################################################
    ...
    @Override
    public KmDate getValueFor(MyFile model)
    {
        return model.getCreatedLocalDate();
    }
    
    @Override
    public boolean hasValueFor(MyFile model, KmDate value)
    {
