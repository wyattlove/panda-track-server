...
public class MySectionFilter
    extends MySectionFilterBase
{
    //##################################################
    //# sort (enum)
    //##################################################
    ...
    @Override
    protected void applyConditionsTo(MySectionCriteria c)
    {
        // none
    }

    @Override
    protected void applySortsTo(MySectionCriteria c)
    {
        if ( !usesSort() )
            return;
