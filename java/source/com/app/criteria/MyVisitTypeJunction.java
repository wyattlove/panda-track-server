...
public class MyVisitTypeJunction
    ...
    implements MyVisitTypeDaoConstantsIF
{
    ...
    public MyVisitTypeJunction(KmJunction context)
    {
        super(context);
    }

    public MyVisitTypeJunction(KmJunction context, KmAbstractCriteria parent)
    {
    ...
    {
        return new MyVisitTypeJunction(context().addAnd(), parent());
    }

    public MyVisitTypeJunction addOr()
    {
        return new MyVisitTypeJunction(context().addOr(), parent());
    }
