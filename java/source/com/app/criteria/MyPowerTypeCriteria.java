...
public class MyPowerTypeCriteria
    extends MyAbstractCriteria<MyPowerType>
    implements MyPowerTypeDaoConstantsIF
{
    ...
    public MyPowerTypeCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyPowerTypeCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    {
        return new MyPowerTypeJunction(parent().addAnd());
    }

    public MyPowerTypeJunction addOr()
    {
        return new MyPowerTypeJunction(parent().addOr());
    }
    ...
    @Override
    public MyPowerTypeCriteria createOn(KmModelJunction junction)
    {
        return new MyPowerTypeCriteria(parent(), junction.context());
    }
