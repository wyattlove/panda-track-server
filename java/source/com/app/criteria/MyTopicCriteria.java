...
public class MyTopicCriteria
    extends MyAbstractCriteria<MyTopic>
    implements MyTopicDaoConstantsIF
{
    ...
    public MyTopicCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyTopicCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    public MySectionCriteria joinToSections()
    {
        return new MySectionCriteria(joinTo(SECTIONS));
    }

    public MySectionCriteria leftJoinToSections()
    {
        return new MySectionCriteria(leftJoinTo(SECTIONS));
    }
    ...
    {
        return new MyTopicJunction(parent().addAnd());
    }

    public MyTopicJunction addOr()
    {
        return new MyTopicJunction(parent().addOr());
    }
    ...
    @Override
    public MyTopicCriteria createOn(KmModelJunction junction)
    {
        return new MyTopicCriteria(parent(), junction.context());
    }
