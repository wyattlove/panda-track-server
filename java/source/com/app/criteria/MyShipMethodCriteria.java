...
public class MyShipMethodCriteria
    extends MyAbstractCriteria<MyShipMethod>
    implements MyShipMethodDaoConstantsIF
{
    ...
    public MyShipMethodCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyShipMethodCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    {
        return new KmStringCriteria(parent(), fullName(CARRIER_UID));
    }
    ...
    {
        return new MyShipMethodJunction(parent().addAnd());
    }

    public MyShipMethodJunction addOr()
    {
        return new MyShipMethodJunction(parent().addOr());
    }
    ...
    @Override
    public MyShipMethodCriteria createOn(KmModelJunction junction)
    {
        return new MyShipMethodCriteria(parent(), junction.context());
    }
