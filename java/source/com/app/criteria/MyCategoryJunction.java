...
public class MyCategoryJunction
    ...
    implements MyCategoryDaoConstantsIF
{
    ...
    public MyCategoryJunction(KmJunction context)
    {
        super(context);
    }

    public MyCategoryJunction(KmJunction context, KmAbstractCriteria parent)
    {
    ...
    public MyCategoryJunction addAnd()
    {
        return new MyCategoryJunction(context().addAnd(), parent());
    }

    public MyCategoryJunction addOr()
    {
        return new MyCategoryJunction(context().addOr(), parent());
    }
