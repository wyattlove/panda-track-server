    ...
    implements MyVendorDaoConstantsIF
{
    ...
    public MyVendorCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyVendorCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    @Override
    public MyVendorCriteria createOn(KmModelJunction junction)
    {
        return new MyVendorCriteria(parent(), junction.context());
    }
