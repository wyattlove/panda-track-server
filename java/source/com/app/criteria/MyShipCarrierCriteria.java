...
public class MyShipCarrierCriteria
    extends MyAbstractCriteria<MyShipCarrier>
    implements MyShipCarrierDaoConstantsIF
{
    ...
    public MyShipCarrierCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyShipCarrierCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    //##################################################
    //# collection (ShipMethods)
    //##################################################

    public MyShipMethodCriteria joinToShipMethods()
    {
        return new MyShipMethodCriteria(joinTo(SHIP_METHODS));
    }

    public MyShipMethodCriteria leftJoinToShipMethods()
    {
        return new MyShipMethodCriteria(leftJoinTo(SHIP_METHODS));
    }
    ...
    {
        return new MyShipCarrierJunction(parent().addAnd());
    }

    public MyShipCarrierJunction addOr()
    {
        return new MyShipCarrierJunction(parent().addOr());
    }
    ...
    @Override
    public MyShipCarrierCriteria createOn(KmModelJunction junction)
    {
        return new MyShipCarrierCriteria(parent(), junction.context());
    }
