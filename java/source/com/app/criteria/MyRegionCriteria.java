...
public class MyRegionCriteria
    extends MyAbstractCriteria<MyRegion>
    implements MyRegionDaoConstantsIF
{
    ...
    public MyRegionCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyRegionCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    {
        return new MyRegionJunction(parent().addAnd());
    }

    public MyRegionJunction addOr()
    {
        return new MyRegionJunction(parent().addOr());
    }
    ...
    @Override
    public MyRegionCriteria createOn(KmModelJunction junction)
    {
        return new MyRegionCriteria(parent(), junction.context());
    }
