...
public class MyVisitTypeCriteria
    extends MyAbstractCriteria<MyVisitType>
    implements MyVisitTypeDaoConstantsIF
{
    ...
    public MyVisitTypeCriteria(KmCriteria parent)
    {
        super(parent);
    }

    public MyVisitTypeCriteria(KmCriteria parent, KmAbstractCriteria context)
    {
    ...
    public MyVisitTypeJunction addAnd()
    {
        return new MyVisitTypeJunction(parent().addAnd());
    }

    public MyVisitTypeJunction addOr()
    {
        return new MyVisitTypeJunction(parent().addOr());
    }
    ...
    @Override
    public MyVisitTypeCriteria createOn(KmModelJunction junction)
    {
        return new MyVisitTypeCriteria(parent(), junction.context());
    }
